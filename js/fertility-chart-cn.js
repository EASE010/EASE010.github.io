/*
    ...
    数据、配色（#ff9966 / #99cc99 / #339966）、y 轴范围 [0.3, 1.9] 和 2px
    线宽都沿用原图表保存的配置。标题、名词解释、图例和数据来源都在正文的
...
(function (global) {
    ...
    var SERIES = [
        { key: 'total',  name: '总和生育率', short: '总和', color: '#ff9966' },
        { key: 'first',  name: '一孩生育率', short: '一孩', color: '#99cc99' },
        { key: 'second', name: '二孩生育率', short: '二孩', color: '#339966' }
    ];
